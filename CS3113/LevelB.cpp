...
void LevelB::initialise()
{
   ...
   mGameState.bgm = LoadMusicStream("assets/game/YTDown.com_YouTube_Sanctuary-Guardians_Media_A_Gj-RJeeng_008_128k.mp3");
   ...
   */
   ...
   mGameState.player = new Entity(
      {mOrigin.x - 700.0f, mOrigin.y + 1300.0f}, // position
      {70.0f , 70.0f},             // scale
   ...
   mGameState.player->setAcceleration({0.0f, 650.0f});
   ...
   { mOrigin.x - 750.0f, mOrigin.y  - 950.0f },
   { 64.0f, 64.0f },
   "assets/game/key.png",
   BLOCK
   );
...
void LevelB::update(float deltaTime)
{
   ...
   {
      mGameState.nextSceneID = 4;   // back to menu, or change if you want a win scene
      return;
   }
